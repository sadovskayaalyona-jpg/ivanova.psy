    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>
          Это инструмент самонаблюдения, а не медицинская диагностика. Тест — авторская методика; идея
          нейромедиаторных типов вдохновлена концепцией Eric Braverman, но вопросы и типология написаны
          самостоятельно.
        </Text>
      </Page>
    </Document>
